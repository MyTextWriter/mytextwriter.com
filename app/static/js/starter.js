        const actionButtonShare = document.getElementById('action-button-share');
        ...
        actionButtonShare.addEventListener('click', () => {
            ...
            new QRCode(qrCodeContainer, {
                text: document.getElementById('share-link').textContent,
                width: 400,
                height: 400
            });
        ...
        copyLink.addEventListener('click', async () => {
            ...
            setTimeout(() => {
                copyLink.innerHTML = '<i class="fas fa-copy"></i> Copy Link';
            }, 2000);
        });
            ...
            if (navigator.share) {
                try {
                    await navigator.share({
                        title: 'MyTextWriter - Shared Text',
                        text: 'Join my text sharing session',
                        url: link
                    });
                } catch (error) {
                ...
                await navigator.clipboard.writeText(link);
                shareNative.innerHTML = '<i class="fas fa-check"></i>';
                setTimeout(() => {
                    shareNative.innerHTML = '<i class="fas fa-share-nodes"></i>';
                }, 2000);
            }
        });
